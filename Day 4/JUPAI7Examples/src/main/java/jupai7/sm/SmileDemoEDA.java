...
public class SmileDemoEDA {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PassengerProviderTest pTestProvider = new PassengerProviderTest ();
        DataFrame testData = pTestProvider.readCSV (sd.testPath);
        System.out.println (testData.structure ());
        System.in.read();
        System.out.println (testData.summary ());
        System.in.read();
        testData = testData.merge (StringVector.of ("Pclass__string",testData.intVector("Pclass").toStringArray()));
        ...
        testData = testData.merge (IntVector.of ("PClassValues",
                encodeCategory (testData, "Pclass__string")));        

        System.out.println ("=======Encoding Non Numeric Data==============");
        System.out.println (testData.structure ());

         System.in.read();
        System.out.println ("=======Dropping the Name and Sex Columns==============");
        testData = testData.drop ("Name");
        testData = testData.drop("Sex");
        testData = testData.drop ("Pclass__string");
        System.out.println (testData.structure ());
         System.in.read();
        System.out.println (testData.summary ());
         System.in.read();
